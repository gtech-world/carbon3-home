    ...
    <ToolsLayout className="text-black">
      ...
      <div className="bg-white p-5 rounded-2xl text-base mt-5 leading-[1.625rem]">
        ...
        <div className="p-5 rounded bg-gray-20">
          <p>A-LCA产品生命周期评价工具客户端：<a className="text-green-2" target="_blank" rel="noreferrer" href="https://gtech-lca-1317970565.cos.ap-shanghai.myqcloud.com/aicpLCA_macOS_x64_1.0.2_2023-07-10.dmg">aicpLCA_macOS_x64_1.0.2_2023-07-10.dmg</a></p>
          <p className="mt-3">A-LCA产品生命周期评价工具客户端：<a className="text-green-2" target="_blank" rel="noreferrer" href="https://gtech-lca-1317970565.cos.ap-shanghai.myqcloud.com/aicpLCA_WINDOWS_X64_1.0.2_2023-07-10.exe">aicpLCA_WINDOWS_X64_1.0.2_2023-07-10.exe</a></p>
        </div>
