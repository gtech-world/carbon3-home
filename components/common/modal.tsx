...
export function ModalHeader(p: { title?: string; titleStyle?: string; containerStyle?: string; onClose?: Function }) {
...
export function Modal(p: ModalProps) {
  const { className, title, onClose, outClose = true, titleStyle, containerStyle, children, ...other } = p;
