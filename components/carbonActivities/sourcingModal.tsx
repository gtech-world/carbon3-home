...
import { MobileSourcingList } from "./mobileSource";

export function SouringModal(p: { data: any; onBack: MouseEventHandler<HTMLButtonElement> }) {
  const { data, onBack } = p;
  return (
    <Modal>
      ...
      <div className="p-5 w-full">
        <MobileSourcingList data={data.sourcings}/>
      </div>
    </Modal>
  );
}
